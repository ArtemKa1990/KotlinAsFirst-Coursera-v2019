...
class Tests {
    ...
    fun sin() {
        ...
        assertEquals(0.0, sin(10 * PI, 1e-5), 1e-5)
        assertEquals(0.017452406459518247, sin(-18.832102629018816, 1.0E-10), 1.0E-10)
        assertEquals(0.0, sin(-18.84955592153876, 1.0E-10), 1.0E-10)
