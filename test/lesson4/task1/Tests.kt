...
class Tests {
    ...
    fun russian() {
        ...
        assertEquals("одиннадцать тысяч пятьсот одиннадцать", russian(11511))
        assertEquals("одиннадцать тысяч триста девять", russian(11309))
        assertEquals("одиннадцать тысяч триста десять", russian(11310))
    }
}